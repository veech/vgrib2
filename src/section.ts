...
export const lookupSections = (parsedSections: SectionValues) => {
  ...
  return [lookupSection0(ins), lookupSection1(ids), lus, lookupSection3(gds), lookupSection4(pds, ins, ids), lookupSection5(drs), bms, lookupSection7(ds, drs, bms), es] as Sections
}
